    ...
    <body ontouchstart >
        ...
        <script>
                $(function () {
                    ...
                    $(".dontpay").addClass('checktit');
                    var loading = false;  //状态标记
                    var url = '<?php echo U("Purchase/waitorders","",true,true);?>';
