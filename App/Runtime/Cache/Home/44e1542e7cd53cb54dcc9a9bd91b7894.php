...
<body >
    <div class="p2bg">
        ...
        <div class="list-group2">
            <span class="tit">10元/月</span>
            <span class="tit">60元</span>
            <span class="tit">60元</span>
            <span class="tit">120元</span>
            <span class="tit">10元</span>
        </div>
        <span class="zs">注：共返还12个月</span>          
        <div class="agree">
            <input id="radio" name="Fruit" type="radio" value="" /><span style="color:#fff;position:relative;top:rem;">我已阅读并同意<span class='rule' style="color:rgb(11, 80, 140)">业务规则</span></span>
        </div>
