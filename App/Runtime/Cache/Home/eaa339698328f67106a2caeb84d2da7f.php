...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/Public/Css/112mycss.css?v=1.0">
    ...
    <body ontouchstart>
        <div class="titlist">
            ...
            <span class="havepay" onclick="window.open('<?php echo U("Purchase/overorders","",true,true);?>', '_self')">已完成</span>
        </div>
        <div class="alllist p1">
            <?php if(empty($list)): ?>您还没有订单<?php endif; ?>
        ...
        <script>
                $(function () {
                    ...
                    var url = '<?php echo U("Purchase/allorders","",true,true);?>';
